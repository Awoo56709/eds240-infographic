...
My goal was to understand what makes a recipe resonate with home cooks and what leads to reviews/scores. I approached this through three guiding questions:
...
To answer these questions, I used data from <a href="https://www.kaggle.com/code/antgoldbloom/most-and-least-popular-recipes-from-food-com">Kaggle</a> that sourced online recipe data from Food.com. This data provided recipe data from the years 1999 to 2019 and included various variables included but limited to:
...
If you would like to reference the code used in creating this infographic, you can access it below. Please note that customized color palettes and other organizational edits were made in <a href="https://www.affinity.studio/">Affinity</a>
...
# Extract top 3 ingredients per category (static version for ggplot sunburst)
